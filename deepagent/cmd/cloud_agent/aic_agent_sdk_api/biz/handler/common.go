...
import (
	...
	"eino-cli/deepagent/cmd/cloud_agent/aic_agent_sdk_api/infra/passport"
	servicecommon "eino-cli/deepagent/cmd/cloud_agent/aic_agent_sdk_api/service/common"
...
func logRequestIdentity(ctx context.Context, identity passport.Identity) {
	logs.CtxInfo(ctx, "[aic_agent_sdk_api] request user identity: user_name=%s email=%s employee_number=%d",
