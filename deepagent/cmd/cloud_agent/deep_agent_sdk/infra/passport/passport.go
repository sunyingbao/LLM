...
const boeTestUIDHeader = "X-Deep-Agent-SDK-Test-UID"
...
func fakePassportEnabled() bool {
	value := strings.TrimSpace(os.Getenv("DEEP_AGENT_SDK_API_FAKE_PASSPORT"))
	return value == "1" || strings.EqualFold(value, "true")
}

func fakeUID() int64 {
	raw := strings.TrimSpace(os.Getenv("DEEP_AGENT_SDK_API_FAKE_UID"))
	if raw == "" {
		return 1234
	}
