...
func runRipgrep(ctx context.Context, root hostSearchRoot, in rgArgs) (result string, err error) {
	...
	if err != nil {
		if errors.Is(err, exec.ErrNotFound) {
			return runLocalRipgrepFallback(in)
		}
...
func runLocalRipgrepFallback(in rgArgs) (output string, err error) {
	grepIn := grepArgs{
		Pattern:         in.Pattern,
