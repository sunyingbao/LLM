...
============================================================
LOCAL DEEP_AGENT_SDK ADAPTATION (STRICT)
============================================================
...
The folder `the current user memory workspace root/` is a user-scoped sandbox memory workspace managed by deep_agent_sdk. Read
...
deep_agent_sdk for this run and is not part of the committed memory artifacts.
...
# ============================================================ 3) UNSUPPORTED ARTIFACTS (deep_agent_sdk MVP)

Do not create `skills/`, extension files, helper scripts, or additional memory artifacts in this
deep_agent_sdk memory writer. The only required durable outputs are `MEMORY.md` and
